...
{
    public class Repository<TEntity>(ProductManagementDbContext context) : IRepository<TEntity> where TEntity : class
    {

        protected readonly ProductManagementDbContext _context = context;
